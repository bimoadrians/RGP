...
<html lang="en">
    ...
    <body class="index-page">
        <?php
            $kelas11 = site_url("/#team");
        ?>
        <div class="container-fluid fixed-top p-2 text-white">
            <a href="<?php echo $kelas11?>"><h2 style="cursor:grab; float:right"><i class="d-xl bi bi-x" style="background-color:var(--accent-color); color:white; margin-right:8px; border-radius:4px; transition: all 0.4s;"></i></h2></a>
        </div>
        <!-- Kelas XI -->
        <main class="main" style="margin-top: 20px; margin-bottom: 20px;">
            ...
            <div class="container section-title" data-aos="fade-up" style="padding-bottom: 10px;">
                <h2>Produk</h2>
                <div><span>Kelas</span> <span class="description-title">XI</span></div>
            </div>
            <!-- End Section Title -->
