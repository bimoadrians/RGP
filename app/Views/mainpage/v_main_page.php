        ...
        <section id="hero" class="hero section dark-background" background-color="#0d4bf0">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <img src="asset/img/logo_rgp.png" width="100%">
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-card">
                            ...
                            <h3>VISI</h3>
                            <p>MENJADI PENERBIT & PERCETAKAN YANG BERSKALA INTERNASIONAL</p>
                            <!-- <ul class="service-features">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-card">
                            ...
                            <h3>MISI</h3>
                            <p>1. Menumbuhkan budaya kerja yang efektif dan efisien.</p>
                            <p>2. Menghasilkan produk buku dan cetakan yang berkualitas.</p>
                            <p>3. Memberikan kesejahteraan yang optimal untuk semua yang terlibat dalam perusahaan.</p>
                            <!-- <ul class="service-features">
                                <li><i class="bi bi-check-circle"></i> Financial Analysis</li>
                                <li><i class="bi bi-check-circle"></i> Investment Planning</li>
                                <li><i class="bi bi-check-circle"></i> Risk Management</li>
                            ...
                            <div class="contact-card">
                                ...
                                <div class="contact-details">
                                    ...
                                    <div class="contact-item">
                                        ...
                                        <div>
                                            <h4>Alamat:</h4>
                                            <p>Jembangan 1 RT. 001 RW. 002, Gagaksipat, Ngemplak,</p>
